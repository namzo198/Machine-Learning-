...
library on the banknote authentication dataset  from the UCI Machine Learning Repository..
"""
import pandas as pd
import matplotlib
...
def data_exploration(Bank_Notes):
     #Viewing the data: involves reducing the data dimensions using PCA
